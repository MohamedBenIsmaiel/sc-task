...
if (argv.f && argv.u && argv.r) {
  getRepo(argv.u, argv.r).then(repo => console.log(repo.dataValues)).catch(e => console.log(e.message))
} else if (argv.f && argv.u) {
  getUser(argv.u).then(user => console.log(user.dataValues)).catch(e => console.error(e.message))
} else if (argv.f) {
...
} else if (argv.li && argv.r) {
  getRepos().then(repos => repos.map(repo => console.log(repo.dataValues))).catch(e => console.log(e))
} else if (argv.li) {
  ...
  getReposByLanguage(argv.rlang).then(repos => repos.map(repo => console.log(repo.dataValues))).catch(e => console.error(e))
} else if (argv.uloc) {
  getUsersByLocation(argv.uloc).then(users => users.map(user => console.log(user.dataValues))).catch(e => console.error(e))
} else if (argv.h) {
  console.log(`
    Options:
       --help       show help
